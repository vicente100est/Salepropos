                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div class="col-md-9" id="variant-section">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label><strong><?php echo e(trans('file.Product Image')); ?></strong> </label> <i class="fa fa-question-circle" data-toggle="tooltip" title="<?php echo e(trans('file.You can upload multiple image. Only .jpeg, .jpg, .png, .gif file can be uploaded. First image will be base image.')); ?>"></i>
...
<script type="text/javascript">
    ...
    $("input[name='variant']").on("input", function () {
        if($("#code").val() == ''){
            ...
            var newRow = $("<tr>");
            var cols = '';
            cols += '<td style="cursor:grab"><i class="ion-grid"></i></td>';
