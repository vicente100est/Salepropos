...
<section>
    <div class="container-fluid">
        <a href="<?php echo e(route('biller.create')); ?>" class="btn btn-info"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Biller')); ?></a>&nbsp;
        <a href="#" data-toggle="modal" data-target="#importbiller" class="btn btn-primary"><i class="fa fa-file"></i> <?php echo e(trans('file.Import Biller')); ?></a>
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="<?php echo e(route('biller.edit', ['id' => $biller->id])); ?>" class="btn btn-link"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?></a> 
                                </li>
                                <li class="divider"></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="public/sample_file/sample_biller.csv" class="btn btn-info btn-block btn-md"><i class="fa fa-download"></i> <?php echo e(trans('file.Download')); ?></a>
                    </div>
                </div>
            </div>
