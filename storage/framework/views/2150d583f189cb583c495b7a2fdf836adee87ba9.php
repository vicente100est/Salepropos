...
<section>
    <div class="container-fluid">
        <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Customer Group')); ?></a>
        <a href="#" data-toggle="modal" data-target="#importcustomer_group" class="btn btn-primary"><i class="fa fa-file"></i> <?php echo e(trans('file.Import Customer Group')); ?></a>
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <button type="button" data-id="<?php echo e($customer_group->id); ?>" class="open-EditCustomerGroupDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <form>
        ...
        <div class="form-group">       
          <label><strong><?php echo e(trans('file.Percentage')); ?>(%) *</strong></label>
      ...
      <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <a href="public/sample_file/sample_customer_group.csv" class="btn btn-info btn-block btn-md"><i class="fa fa-download"></i>  <?php echo e(trans('file.Download')); ?></a>
                </div>
            </div>
      </div>
