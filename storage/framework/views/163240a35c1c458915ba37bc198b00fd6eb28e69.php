...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Holiday')); ?> </button>
    </div>
                ...
                <tr data-id="<?php echo e($holiday->id); ?>">
                    ...
                    <td>
                        <div class="btn-group">
                        	...
                        	<?php endif; ?>
                        	<button type="button" class="btn btn-sm btn-primary btn-edit" title="<?php echo e(trans('file.edit')); ?>" data-id="<?php echo e($holiday->id); ?>" data-from="<?php echo e(date($general_setting->date_format, strtotime($holiday->from_date))); ?>" data-to="<?php echo e(date($general_setting->date_format, strtotime($holiday->to_date))); ?>" data-note="<?php echo e($holiday->note); ?>" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit"></i></button>
                            <?php echo e(Form::open(['route' => ['holidays.destroy', $holiday->id], 'method' => 'DELETE'] )); ?>

                            <button type="submit" class="btn btn-sm btn-danger" onclick="return confirmDelete()" title="<?php echo e(trans('file.delete')); ?>"><i class="fa fa-trash"></i></button>
