...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#gift_card-modal"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Gift Card')); ?></button>
    </div>
            ...
            <div class="modal-body">
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                ...
                ?>
                  ...
                  <div class="form-group">
                      <label><strong><?php echo e(trans('file.User List')); ?></strong></label>&nbsp;
