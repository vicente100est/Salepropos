...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#create-modal"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Coupon')); ?></button>
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li><button type="button" data-id="<?php echo e($coupon->id); ?>" data-code="<?php echo e($coupon->code); ?>" data-type="<?php echo e($coupon->type); ?>" data-amount="<?php echo e($coupon->amount); ?>" data-minimum_amount="<?php echo e($coupon->minimum_amount); ?>" data-quantity="<?php echo e($coupon->quantity); ?>" data-expired_date="<?php echo e($coupon->expired_date); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?></button></li>
                ...
                <?php echo Form::open(['route' => 'coupons.store', 'method' => 'post']); ?>
                  ...
                  <div class="row">
                      <div class="col-md-6 form-group">
                          <label><strong><?php echo e(trans('file.Coupon Code')); ?> *</strong></label>
                      ...
                      <div class="col-md-6 form-group minimum-amount">
                          <label><strong><?php echo e(trans('file.Minimum Amount')); ?> *</strong></label>
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                    <label><strong><?php echo e(trans('file.Coupon')); ?> <?php echo e(trans('file.Code')); ?> *</strong></label>
                    <div class="input-group">
