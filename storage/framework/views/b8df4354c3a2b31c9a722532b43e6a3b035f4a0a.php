...
<section>
    ...
    <div class="container-fluid">
        <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-info"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Employee')); ?></a>
    </div>
    <?php endif; ?>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <button type="button" data-id="<?php echo e($employee->id); ?>" data-name="<?php echo e($employee->name); ?>" data-email="<?php echo e($employee->email); ?>" data-phone_number="<?php echo e($employee->phone_number); ?>" data-department_id="<?php echo e($employee->department_id); ?>" data-address="<?php echo e($employee->address); ?>" data-city="<?php echo e($employee->city); ?>" data-country="<?php echo e($employee->country); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?></button> 
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
            ...
            <div class="modal-body">
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        <label><strong><?php echo e(trans('file.Department')); ?> *</strong></label>
