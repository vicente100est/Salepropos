...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Payroll')); ?> </button>
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <button type="button" data-id="<?php echo e($payroll->id); ?>" data-reference="<?php echo e($payroll->reference_no); ?>" data-employee="<?php echo e($payroll->employee_id); ?>" data-account="<?php echo e($payroll->account_id); ?>" data-amount="<?php echo e($payroll->amount); ?>" data-note="<?php echo e($payroll->note); ?>" data-paying_method="<?php echo e($payroll->paying_method); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?></button> 
                                </li>
                                <li class="divider"></li>
              ...
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label><strong><?php echo e(trans('file.Employee')); ?> *</strong></label>
                    ...
                    <div class="col-md-6 form-group">
                        <label><strong><?php echo e(trans('file.Method')); ?> *</strong></label>
