                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong><?php echo e(trans('file.Default Customer')); ?> *</strong></label>
                                    ...
                                    <div class="form-group">
                                        <label><strong><?php echo e(trans('file.Default Biller')); ?> *</strong></label>
                                        <?php if($lims_pos_setting_data): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong><?php echo e(trans('file.Default Warehouse')); ?> *</strong></label>
                                        <?php if($lims_pos_setting_data): ?>
