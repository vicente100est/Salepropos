...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i> <?php echo e(trans('file.Count Stock')); ?> </button>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a download href="<?php echo e('public/stock_count/'.$stock_count->initial_file); ?>" title="<?php echo e(trans('file.Download')); ?>"><i class="fa fa-file"></i></a>
                    </td>
                    <td class="text-center">
                        <?php if($stock_count->final_file): ?>
                        <a download href="<?php echo e('public/stock_count/'.$stock_count->final_file); ?>" title="<?php echo e(trans('file.Download')); ?>"><i class="fa fa-file"></i></a>
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php if($stock_count->final_file): ?>
...
<script type="text/javascript">
    ...
    $('.final-report').on('click', function(){
        ...
        htmltext += '<br><span class="d-print-none mt-1"><strong><?php echo e(trans("file.Files")); ?>: </strong>&nbsp;&nbsp;<a href="'+stock_count[6]+'" class="btn btn-sm btn-primary"><i class="fa fa-download"></i> <?php echo e(trans("file.Initial File")); ?></a>&nbsp;&nbsp;<a href="'+stock_count[7]+'" class="btn btn-sm btn-info"><i class="fa fa-download"></i> <?php echo e(trans("file.Final File")); ?></a></span>';
        $.get('stock-count/stockdif/' + stock_count[8], function(data){
            ...
            if(name_code){
                ...
                if( !parseInt(data[5]) ) {
                    htmlFooter = '<a class="btn btn-primary d-print-none" href="stock-count/'+stock_count[8]+'/qty_adjustment"><i class="fa fa-plus"></i> <?php echo e(trans("file.Add Adjustment")); ?></a>';
