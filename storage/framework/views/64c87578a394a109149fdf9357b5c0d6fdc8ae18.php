...
<section>
    <div class="container-fluid">
        <a href="<?php echo e(route('qty_adjustment.create')); ?>" class="btn btn-info"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Adjustment')); ?></a>
    </div>
    <div class="table-responsive">
        <table id="adjustment-table" class="table table-striped purchase-list">
            <thead>
                <tr>
