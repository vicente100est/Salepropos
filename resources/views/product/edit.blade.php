                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" id="promotion_price">   <label><strong>{{trans('file.Promotional Price')}}</strong></label>
...
<script type="text/javascript">
    ...
    $("input[name='variant']").on("input", function () {
        if($("#code").val() == ''){
            ...
            var newRow = $("<tr>");
            var cols = '';
            cols += '<td style="cursor:grab"><i class="ion-grid"></i><input type="hidden" name="product_variant_id[]" value="0"></td>';
